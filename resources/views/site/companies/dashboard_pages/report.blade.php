    ...
    <div class="container">
        <div class="wrap">
            ...
            <div class="repthead-right">
                <p>Download</p>
                <p><a href="{{url('/company/dashboard/report/pdf/'. $status.'/'.$locations.'/'.$start_date.'/'.$end_date)}}"><img src="{{url('images/doc.png')}}"></a>
                    <a href="{{url('/company/dashboard/report/csv/'. $status.'/'.$locations.'/'.$start_date.'/'.$end_date)}}"><img src="{{url('images/doc1.png')}}"></a></p>
            </div>
