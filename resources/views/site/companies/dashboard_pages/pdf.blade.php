        ...
        <div class="wrap">
            ...
            <table class="meeting-report" style="border-collapse: collapse;border-color:#d4d4d4;width: 100%;">
                <tr class="meeting-head">
                    ...
                    <th style="text-align: left; background-color: #b11f5f;color: #fff;font-size:13px;font-weight:700;border: 1px solid #d4d4d4;padding: 10px 20px;text-align: center;">Booking Number</th>
