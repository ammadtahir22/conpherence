        ...
        <div class="wrap">
            ...
            <table class="meeting-report" style="border-collapse: collapse;border-color:#d4d4d4;width: 100%;">
                <tr class="meeting-head">
                    ...
                    <th style="text-align: left; background-color: #b11f5f;color: #fff;font-size:13px;font-weight:700;border: 1px solid #d4d4d4;padding: 10px 20px;">Discount Amount</th>
                </tr>
                ...
                @foreach($bookings as $key => $booking)
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">{{$booking->booking_number}}</td>
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">{{$booking->purpose}}</td>
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">{{get_venue_title($booking->venue_id)}} ({{get_city_by_venue($booking->venue_id)}})</td>
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">{{get_space_title($booking->space_id)}}</td>
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">{{date('d M Y', strtotime($booking->start_date))}}</td>
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">AED   {{number_format($booking->grand_total, 2)}}/-</td>
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">AED   {{number_format($discount, 2)}}/-</td>
                    </tr>
            ...
            <table width="100%" style="background:#fff;font-size: 14px;color: #302f2f;padding-top: 15px;margin-top: 50px;margin-bottom: 50px;">
                <tr>
                    ...
                    <td align="right" class="report-total" style=" color: #b11f5f;padding-right: 40px;font-size: 16px;"><p style="margin-bottom: 10px;">Total Discount <span>AED   {{number_format($total_discount, 2)}}/-</span></p><img src="images/bar.png" alt="" style="width: 200px" /></td>
                </tr>
            </table>
