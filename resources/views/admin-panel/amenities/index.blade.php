    ...
    <div id="main" role="main">
        ...
        <div id="ribbon">
            ...
            {{--</span>--}}
                    ...
                    <!-- breadcrumb -->
            <ol class="breadcrumb">
                <li>Home</li><li>All Amenities</li>
            </ol>
            <!-- end breadcrumb -->
                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            ...
                                            @if(isset($amenities))
                                                @foreach($amenities as $key => $amenitie)
                                                    @if($amenitie->name != 'Uncategorized')
                                                        <tr>
                                                            <td>{{$key+1}}</td>
                                                            <td>{{$amenitie->name}}</td>
                                                            <td>{{date('Y-m-d', strtotime($amenitie->created_at))}}</td>
                                                            <td>
                                                                <a href="{{url('/admin/amenities/edit/'. $amenitie->id)}}" class="">
                                                                    <i class="fa fa-pencil-square-o fa-lg"></i>
                                                                </a>

                                                                <a href="{{url('/admin/amenities/delete/'. $amenitie->id)}}" class="" onclick="return confirm('Are you sure you want to delete?');">
