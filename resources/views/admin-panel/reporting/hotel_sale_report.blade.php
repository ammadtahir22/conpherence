    ...
    <div id="main" role="main">
        ...
        <div id="content">
            ...
            <section id="widget-grid" class="">
                <!-- row -->
                <div class="row">
                    <form action="{{route('admin.gethotel.salereport')}}" method="post" id="earning_report_form">
                    @csrf
                    <!-- NEW WIDGET START -->
                            ...
                            <div class="jarviswidget" id="wid-id-0">
                                ...
                                <div class="widget-body">
                                    <div class="form-horizontal">
                                        <fieldset>
                                            <legend>Hotel Sale Report</legend>
                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            ...
                                            @foreach($sales as $key => $sale)
                                                <tr>
                                                    ...
                                                    <td>@if($sale->status == 0) Pending @elseif($sale->status == 1) Approved @else Cancelled @endif</td>
