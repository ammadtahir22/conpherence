...
<section class="generated-report">
    <div class="container">
        <div class="wrap">
            ...
            <h1 style="color: #b11f5f;font-weight: 700;font-size: 26px; position: relative;">Booking Report</h1>
            ...
            <table width="100%" style="border: 1px solid #d4d4d4; margin-top:30px;margin-bottom: 10px;">
                <tr>
                    ...
                    <td style="padding: 15px;    border-left: 1px solid #d4d4d4;">
                        ...
                        <h2 style="font-size: 16px;margin: 10px 0px 5px 0px;color: #302f2f;font-weight: 700;">From {{date('d M Y', strtotime($start_date))}}<span>To {{date('d M Y', strtotime($end_date))}}</h2>
                    </td>
                </tr>
            </table>
            <table class="meeting-report" style="border-collapse: collapse;border-color:#d4d4d4;width: 100%;">
                <tr class="meeting-head">
                    <th style="text-align: left; background-color: #b11f5f;color: #fff;font-size:13px;font-weight:700;border: 1px solid #d4d4d4;padding: 10px 20px;text-align: center;">Sr#</th>
                    <th style="text-align: left; background-color: #b11f5f;color: #fff;font-size:13px;font-weight:700;border: 1px solid #d4d4d4;padding: 10px 20px;">Customer Name</th>
                    <th style="text-align: left; background-color: #b11f5f;color: #fff;font-size:13px;font-weight:700;border: 1px solid #d4d4d4;padding: 10px 20px;">Customer Email</th>
                ...
                @foreach($report_data as $key => $bookingreport)
                    <tr>
                        ...
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">{{get_user_name($bookingreport->user_id)}}</td>
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">{{get_user_email($bookingreport->user_id)}}</td>
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">{{$bookingreport->purpose}}</td>
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">{{get_venue_title($bookingreport->venue_id)}} ({{get_city_by_venue($bookingreport->venue_id)}})</td>
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">{{get_space_title($bookingreport->space_id)}}</td>
                        ...
                        <td style="border: 1px solid #d4d4d4; padding: 15px 17px; color:#302f2f;font-size:14px;font-weight: 500;">AED   {{$bookingreport->grand_total}}/-</td>
            ...
            <table width="100%" style="background:#fff;font-size: 14px;color: #302f2f;padding-top: 15px;margin-top: 50px;margin-bottom: 50px;">
                <tr>
                    <td align="right" class="report-total" style=" color: #b11f5f;padding-right: 40px;font-size: 16px;"><p style="margin-bottom: 10px;">Total <span>AED   {{$total_amount}}/-</span></p><img src="images/bar.png" alt="" style="width: 200px" /></td>
                </tr>
            </table>
