    ...
    <div id="main" role="main">
        ...
        <!-- breadcrumb -->
            <ol class="breadcrumb">
                @if(isset($category->id) && $category->id != '')
                    <li>Home / Edit Career Category</li>
                @else
                    <li>Home / Add Career Category</li>
                @endif
            </ol>
        ...
        <div id="content">
            ...
            <section id="widget-grid" class="">
                <!-- row -->
                <div class="row">
                    <form action="{{url('/admin/career/category/save')}}" method="post" id="add_category_form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="jarviswidget" id="wid-id-0">
                            ...
                            <div class="widget-body">
                                <div class="form-horizontal">
                                    <fieldset>
                                        @if(isset($category->id) && $category->id != '')
                                            <legend>Edit Career Category</legend>
                                        @else
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <a href="{{ route('all.career.categories') }}" class="btn btn-default"> Cancel </a>
