...
@section('main-panel')
    <div id="main" role="main">
        ...
        <!-- breadcrumb -->
            <ol class="breadcrumb">
                <li>Home</li><li>All Career Categories</li>
            </ol>
            <!-- end breadcrumb -->
                                        ...
                                        @if(isset($categories))
                                            @foreach($categories as $key => $category)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('/admin/career/category/edit/'. $category->id)}}" class="">
                                                            <i class="fa fa-pencil-square-o fa-lg"></i>
                                                        </a>

                                                        <form style="display: inline" action="{{ url('admin/career/category/delete/'.$category->id)}}" method="post">
