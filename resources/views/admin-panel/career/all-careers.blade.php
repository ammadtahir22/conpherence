                                        ...
                                        @if(isset($careers))
                                            @foreach($careers as $key => $career)
                                                <tr>
                                                    ...
                                                    <td>{{date('Y-m-d', strtotime($career->created_at))}}</td>
                                                    <td>{{$career->career_category->title}}</td>
                                                    @php $activated = $career->status == 1  ? 'Publish' : 'Draft'; @endphp
                                                    <td>{{$activated}}</td>
                                                    <td>
                                                        <a href="{{url('/admin/career/edit/'. $career->id)}}" class="">
                                                            <i class="fa fa-pencil-square-o fa-lg"></i>
                                                        </a>

                                                        <form style="display: inline" action="{{ url('admin/career/delete/'.$career->id)}}" method="post">
