                                    ...
                                    <fieldset class="demo-switcher-1">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-10">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" class="radiobox style-0" name="status" {{ $pages->status == 1 ? 'checked="checked"' : '' }} value="1">
                                                        <span>Publish</span>
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" class="radiobox style-0"  name="status" {{ $pages->status == 0 ? 'checked="checked"' : '' }} value="0">
                                                        <span>Draft</span>
                                                    </label>
                                                </div>
                                            </div>
