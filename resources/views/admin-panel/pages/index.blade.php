                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="remove-sort" data-hide="phone,tablet">Action</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @if(isset($pages))
                                            @foreach($pages as $key => $page)
                                                ...
                                                <tr>
                                                    ...
                                                    @php $activated = $page->status == 1  ? 'Active' : 'Deactive'; @endphp
                                                    <td>{{$activated}}</td>
                                                    <td>
                                                        <a href={{ url('admin/page/'.$page->id.'/edit') }} title="Edit">
                                                            <i class="fa fa-edit"></i>
                                                        </a>

                                                        <form style="display: inline" action="{{ url('admin/page/'.$page->id.'/delete')}}"
                                                              method="post">
...
@section('scripts')
    ...
    <script>
        function changepagesStatus(id) {

            var form_id = '#pages_status_form'+id;
