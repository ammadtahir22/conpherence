    ...
    <div id="main" role="main">
        ...
        <div id="content">
            ...
            <section id="widget-grid" class="">
                <!-- row -->
                <div class="row">
                    <form action="{{url('/admin/page/save')}}" method="post" id="add_post_form">
                        @csrf
                        <!-- NEW WIDGET START -->
                                    ...
                                    <div class="form-horizontal">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" name="keyword" placeholder="Meta Keyword" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea class="form-control" name="seo" rows="3" placeholder="Meta Description"></textarea>
                                                </div>
                                            </div>
                            ...
                            <div class="jarviswidget" id="wid-id-0">
                                ...
                                <div class="widget-body">
                                    <fieldset class="demo-switcher-1">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-10 page_status_radio">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" class="radiobox style-0" name="status" value="1">
                                                        <span>Publish</span>
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" class="radiobox style-0"  name="status" value="0">
                                                        <span>Draft</span>
                                                    </label>
                                                </div>
                                            </div>
