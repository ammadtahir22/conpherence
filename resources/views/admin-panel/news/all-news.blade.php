                                        ...
                                        @if(isset($news))
                                            @foreach($news as $key => $new)
                                                <tr>
                                                    ...
                                                    <td>{{$new->news_category->title}}</td>
                                                    @php $activated = $new->status == 1  ? 'Publish' : 'Draft'; @endphp
                                                    <td>{{$activated}}</td>
                                                    <td>
                                                        <a href="{{url('/admin/news/edit/'. $new->id)}}" class="">
                                                            <i class="fa fa-pencil-square-o fa-lg"></i>
                                                        </a>

                                                        <form style="display: inline" action="{{ url('admin/news/delete/'.$new->id)}}" method="post">
