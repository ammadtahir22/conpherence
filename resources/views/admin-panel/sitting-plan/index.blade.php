    ...
    <div id="main" role="main">
        ...
        <div id="ribbon">
            ...
            {{--</span>--}}
                    ...
                    <!-- breadcrumb -->
            <ol class="breadcrumb">
                <li>Home</li><li>All Sitting plans</li>
            </ol>
            <!-- end breadcrumb -->
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            ...
                                            <tbody>
                                            @if(isset($sittingplans))
                                                @foreach($sittingplans as $key => $sittingplan)
                                                    @if($sittingplan->title != 'Uncategorized')
                                                        <tr>
                                                            <td>{{$key+1}}</td>
                                                            <td>{{$sittingplan->title}}</td>
                                                            <td>{{date('Y-m-d', strtotime($sittingplan->created_at))}}</td>
                                                            <td>
                                                                <a href="{{url('/admin/sitting-plan/edit/'. $sittingplan->id)}}" class="">
                                                                    <i class="fa fa-pencil-square-o fa-lg"></i>
                                                                </a>


                                                                <a href="{{url('/admin/sitting-plan/delete/'. $sittingplan->id)}}" class="" onclick="return confirm('Are you sure you want to delete?');">
