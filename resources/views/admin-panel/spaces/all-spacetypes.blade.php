    ...
    <div id="main" role="main">
        ...
        <div id="ribbon">
            ...
            {{--</span>--}}
                    ...
                    <!-- breadcrumb -->
            <ol class="breadcrumb">
                <li>Home</li><li>All Spaces Types</li>
            </ol>
            <!-- end breadcrumb -->
                                            ...
                                            @if(isset($spacetypes))
                                                @foreach($spacetypes as $key => $spacetype)
                                                    @if($spacetype->title != 'Uncategorized')
                                                        <tr>
                                                            <td>{{$key+1}}</td>
                                                            <td>{{$spacetype->title}}</td>
                                                            {{--<td>{{$spacetype->slug}}</td>--}}
                                                            <td>{{$spacetype->description}}</td>
                                                            <td>{{date('Y-m-d', strtotime($spacetype->created_at))}}</td>
                                                            <td>
                                                                <a href="{{url('admin/space/spacetype/edit/'. $spacetype->id)}}" class="">
                                                                    <i class="fa fa-pencil-square-o fa-lg"></i>
                                                                </a>

                                                                <a href="{{url('admin/space/spacetype/delete/'. $spacetype->id)}}" class="" onclick="return confirm('Are you sure you want to delete?');">
