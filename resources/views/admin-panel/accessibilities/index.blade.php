    ...
    <div id="main" role="main">
        ...
        <div id="ribbon">
            ...
            {{--</span>--}}
                    ...
                    <!-- breadcrumb -->
            <ol class="breadcrumb">
                <li>Home</li><li>All Accessibilities</li>
            </ol>
            <!-- end breadcrumb -->
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                            ...
                                            <tbody>
                                            @if(isset($accessibilities))
                                                @foreach($accessibilities as $key => $accessibilitie)
                                                    @if($accessibilitie->name != 'Uncategorized')
                                                        <tr>
                                                            <td>{{$key+1}}</td>
                                                            <td>{{$accessibilitie->name}}</td>
                                                            <td>{{date('Y-m-d', strtotime($accessibilitie->created_at))}}</td>
                                                            <td>
                                                                <a href="{{url('/admin/accessibilities/edit/'. $accessibilitie->id)}}" class="">
                                                                    <i class="fa fa-pencil-square-o fa-lg"></i>
                                                                </a>
                                                                <a href="{{url('/admin/accessibilities/delete/'. $accessibilitie->id)}}" class="" onclick="return confirm('Are you sure you want to delete?');">
