...
@section('main-panel')
    <div id="main" role="main">
        ...
        <!-- breadcrumb -->
            <ol class="breadcrumb">
                <li>Home</li><li>All Food Types</li>
            </ol>
            <!-- end breadcrumb -->
                                    ...
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        @if(isset($food_types))
                                            @foreach($food_types as $key => $food_type)
                                                @if($food_type->title != 'Uncategorized')
                                                <tr>
                                                    <td>{{$key+1}}</td>
                                                    <td>{{$food_type->title}}</td>
                                                    <td>{{date('Y-m-d', strtotime($food_type->created_at))}}</td>
                                                    <td>
                                                        <a href="{{url('/admin/food/type/edit/'. $food_type->id)}}" class="">
                                                            <i class="fa fa-pencil-square-o fa-lg"></i>
                                                        </a>

                                                        <form style="display: inline" action="{{ url('admin/food/type/delete/'.$food_type->id)}}" method="post">
