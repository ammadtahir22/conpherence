    ...
    <div id="main" role="main">
        ...
        <!-- breadcrumb -->
            @if(isset($category->id) && $category->id != '')
                <ol class="breadcrumb">
                    <li>Home / Edit Post Category</li>
                </ol>
            @else
                <ol class="breadcrumb">
                    <li>Home / Add Post Category</li>
                </ol>
            @endif
        </div>
        <!-- END RIBBON -->
        ...
        <div id="content">
            ...
            <section id="widget-grid" class="">
                <!-- row -->
                <div class="row">
                    <form action="{{url('/admin/post/category/save')}}" method="post" id="add_category_form" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <a href="{{ route('all.post.categories') }}" class="btn btn-default"> Cancel </a>
