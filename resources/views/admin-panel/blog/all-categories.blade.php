...
@section('main-panel')
    <div id="main" role="main">
        ...
        <!-- breadcrumb -->
            <ol class="breadcrumb">
                <li>Home</li><li>All Post Categories</li>
            </ol>
            <!-- end breadcrumb -->
                                        ...
                                        @if(isset($categories))
                                            @foreach($categories as $key => $category)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('/admin/post/category/edit/'. $category->id)}}" class="">
                                                            <i class="fa fa-pencil-square-o fa-lg"></i>
                                                        </a>

                                                        <form style="display: inline" action="{{ url('admin/post/category/delete/'.$category->id)}}" method="post">
