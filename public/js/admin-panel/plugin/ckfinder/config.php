<?php
//$upload_path = $_SERVER['HTTP_REFERER'];
//
//$upload_path = explode('public/', $upload_path);
//$upload_path = $upload_path[0];
//$upload_path = $upload_path . 'public/storage/images/ckeditor/';


//if(strpos($upload_path,'public/') !== false){
//    $upload_path = explode('public/', $upload_path);
//    $upload_path = $upload_path[0];
//    $upload_path = $upload_path . 'public/storage/images/ckeditor/';
//}else if(strpos($upload_path,'adminmedia/') !== false){
//    $upload_path = explode('adminmedia/', $upload_path);
//    $upload_path = $upload_path[0];
//    $upload_path = $upload_path . 'public/storage/images/ckeditor/';
//}


$upload_path = 'http://localhost/conpherence/public/storage/images/ckeditor';
...
{
    $upload_path = $protocol.$_SERVER['SERVER_NAME'].'/conpherence/public/storage/images/ckeditor';
} else {
    $upload_path = $protocol.$_SERVER['SERVER_NAME'].'/public/storage/images/ckeditor';
}
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      =>  $upload_path,//'https://localhost/view_and_ask/public/plugins/ckfinder/userfiles/',
