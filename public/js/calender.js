...
//
// var dateObject = pikadayResponsive(document.getElementById("end-date"));
var startDate,
    endDate,
...
// console.log(new Date(bookingStartDate.setDate(bookingStartDate.getDate() + 7)));

// for booking
var bookingStartDate,
    bookingEndDate,
    MaxEndDate,
    bookingUpdateStartDate = function() {
        bookingStartPicker.setStartRange(bookingStartDate);
        bookingEndPicker.setStartRange(bookingStartDate);
        bookingEndPicker.setMinDate(bookingStartDate);
        bookingEndPicker.setMaxDate(MaxEndDate);

    },
    bookingUpdateEndDate = function() {
        bookingStartPicker.setEndRange(bookingEndDate);
        bookingStartPicker.setMaxDate(bookingEndDate);
        bookingEndPicker.setEndRange(bookingEndDate);
    },
    bookingStartPicker = new Pikaday({
        field: document.getElementById('booking_date'),
        minDate: new Date(),
        maxDate: new Date(2020, 12, 31),
        onSelect: function() {
            bookingStartDate = this.getDate();
            MaxEndDate = this.getDate();
            MaxEndDate = new Date(MaxEndDate.setDate(MaxEndDate.getDate() + 7));
            bookingUpdateStartDate();
        }
    }),
    bookingEndPicker = new Pikaday({
        field: document.getElementById('booking_end_date'),
        minDate: new Date(),
        maxDate: new Date(2020, 12, 31),
        onSelect: function() {
            bookingEndDate = this.getDate();
            bookingUpdateEndDate();
        }
    }),
    _bookingStartDate = bookingStartPicker.getDate(),
    _bookingEndDate = bookingEndPicker.getDate();
if (_bookingStartDate) {
